...
SWEP.UseHands					= true
	...
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/weapons/cstrike/c_mach_m249para.mdl" -- The view model (First person)
SWEP.WorldModel					= "models/weapons/w_mach_m249para.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
