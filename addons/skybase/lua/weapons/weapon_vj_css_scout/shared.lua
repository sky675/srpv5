...
SWEP.UseHands					= true
	...
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/weapons/cstrike/c_snip_scout.mdl" -- The view model (First person)
SWEP.WorldModel					= "models/weapons/w_snip_scout.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
...
SWEP.NPC_NextPrimaryFire 		= 1.0 -- Next time it can use primary fire
...
SWEP.Primary.DefaultClip		= 300 -- How much ammo do you get when you first pick up the weapon?
SWEP.Primary.TakeAmmo			= 1 -- How much ammo should it take o
