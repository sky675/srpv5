...
SWEP.Category					= "VJ CSS"
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/weapons/v_rif_galil.mdl" -- The view model (First person)
SWEP.WorldModel					= "models/weapons/w_rif_galil.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
