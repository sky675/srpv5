...
SWEP.Category					= "VJ CSS"
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/weapons/cstrike/c_snip_sg550.mdl" -- The view model (First person)
SWEP.WorldModel					= "models/weapons/w_snip_sg550.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
