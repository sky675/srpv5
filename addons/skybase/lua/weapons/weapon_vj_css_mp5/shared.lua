...
SWEP.UseHands					= true
	...
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/weapons/cstrike/c_smg_mp5.mdl" -- The view model (First person)
SWEP.WorldModel					= "models/weapons/w_smg_mp5.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
