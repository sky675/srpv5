...
SWEP.UseHands					= true
	...
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/weapons/cstrike/c_smg_mac10.mdl" -- The view model (First person)
SWEP.WorldModel					= "models/weapons/w_pist_p228.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
SWEP.HoldType 					= "revolver" -- List of holdtypes are in the GMod wiki
SWEP.Spawnable					= true
SWEP.AdminSpawnable				= false
	-- NPC Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.NPC_EnableDontUseRegulate 	= true -- Used for VJ Base SNPCs, if enabled the SNPC will remove use regulate
SWEP.NPC_NextPrimaryFire 		= 0.23 -- Next time it can use primary fire
SWEP.NPC_UsePistolBehavior 		= false -- Should it check the pistol activities when the NPC is firing the weapon?
SWEP.NPC_CustomSpread	 		= 0.74 -- This is added on top of the custom spread that's set inside the SNPC! | Starting from 1: Closer to 0 = better accuracy, Farther than 1 = worse accuracy
-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Recoil				= 0.32 -- How much recoil does the player get?
SWEP.Primary.Cone				= 7 -- How accurate is the bullet? (Players)
SWEP.Primary.Delay				= 0.23 -- Time until it can shoot again
