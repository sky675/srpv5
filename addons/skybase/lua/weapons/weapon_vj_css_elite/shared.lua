...
SWEP.WorldModel					= "models/weapons/w_pist_elite_single.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
...
SWEP.NPC_CustomSpread	 		= 0.7 -- This is added on top of the custom spread that's set inside the SNPC! | Starting from 1: Closer to 0 = better accuracy, Farther than 1 = worse accuracy
-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
