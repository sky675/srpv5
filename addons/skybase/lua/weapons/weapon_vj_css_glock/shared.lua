...
SWEP.WorldModel					= "models/weapons/w_pist_glock18.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
...
SWEP.Primary.Force				= 6 -- Force applied on the object the bullet hits
...
SWEP.Primary.Recoil				= 0.33 -- How much recoil does the player get?
