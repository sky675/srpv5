...
SWEP.UseHands					= true
	...
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/weapons/cstrike/c_rif_m4a1.mdl" -- The view model (First person)
SWEP.WorldModel					= "models/weapons/w_rif_m4a1.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
