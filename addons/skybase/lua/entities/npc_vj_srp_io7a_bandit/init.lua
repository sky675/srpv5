...
local replacemats = {
	--[origmat] = newmat,
	["models/sky/stalker/io7a_lone"] = "models/sky/stalker/io7a_band",

}
--and this too so dont have to modify below this
local maletop = "models/sky/seperate/male_io7a.mdl"
local femaletop = "models/sky/seperate/female_io7a.mdl"
...
function ENT:CustomOnDeath_AfterCorpseSpawned(dmginfo,hitgroup,ply) 
	...
	local topmodel = "models/sky/seperate/male_io7a.mdl"
	if(self.fem or string.find(self.GetModel and self:GetModel() or "", "female")) then
		topmodel = "models/sky/seperate/female_io7a.mdl"
	end
