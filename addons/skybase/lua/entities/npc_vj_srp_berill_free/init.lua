...
local maletop = "models/sky/seperate/male_berill.mdl"
local femaletop = "models/sky/seperate/female_berill.mdl"
...
function ENT:CustomOnDeath_AfterCorpseSpawned(dmginfo,hitgroup,ply) 
	...
	local topmodel = "models/sky/seperate/male_berill.mdl"
	if(self.fem or string.find(self.GetModel and self:GetModel() or "", "female")) then
		topmodel = "models/sky/seperate/female_berill.mdl"
	end
