...
nut.chat.register("radio", {
	desc = "Speak into a radio you have or use the commlink cyberware in English",
	...
	onCanSay = function(speaker, text)
		...
		if (speakerInv) then
			for k, v in pairs(speakerInv:getItems()) do
				...
				for id, far in pairs(find) do
					if (v.uniqueID == id and v:getData("power", false) == true and v:getData("listenonly", false) == false) then
...
nut.chat.register("radiow", {
	desc = "Whisper into a radio you have in English",
