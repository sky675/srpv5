--this https://github.com/rebel1324/BlackTea-Nutscript-Plugins/blob/master/nightvision.lua
--also like add functions to easily set??
--also will need content extracted (think it is already idk)
PLUGIN.name = "Nightvision"
PLUGIN.author = "Black Tea/sky"
PLUGIN.desc = "night vision addon by spy, converted to ns by black tea and edited for use with suits by sky."

--ok so this took me a bit but i get it:
--activate it by: 
--[[
    setting NV_Status = true, and this line
	hook.Add("RenderScreenspaceEffects", "NV_FX", NV_FX)
]]
--and remove it by:
--[[
    setting NV_Status = false, and this line
	hook.Remove("RenderScreenspaceEffects", "NV_FX")
]]
--if u want, u can surface.PlaySound the sounds
...
if (CLIENT) then
    ...
    --concommand.Add("nv_reset_everything", NV_ResetEverything) --is this needed honestly?
