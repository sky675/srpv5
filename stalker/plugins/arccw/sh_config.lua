...
local attList = {
	...
	["mifl_fas2_ubw_m203"] = {
		...
		category = "Attachments",
		flag = "k",--any flag in this will make it return true
		cat = "ubgl", --attid should be id of item
		--useSound = "", --sound to use instead of atts own
		iconCam = {
	...
	["mifl_fas2_optic_elcan"] = {
		name = "Elcan Hunter Scope (3.5x)",
		desc = "A camouflaged scope with backup ironsights.",
		price = 14500,
		model = "models/weapons/arccw_go/atts/elcan.mdl",
		width = 2,
		height = 1,
...
local ammoList = {
	...
	["ammo_46"] = {
		...
		maxQuantity = 30,
		iconCam = {
			pos = Vector(-44.63826751709, -15.996829986572, 23.218173980713),
			ang = Angle(20.339117050171, 19.90358543396, 1.411048412323),
			entAng = Angle(0, 0, -0),
			fov = 45,
		},		
		--defQuantity = 50,
	...
	--0.65
	["ammo_9x19_old"] = {
		name = "9x19mm OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 699, --23ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_9x19_fmj_old.mdl",
		width = 1,
		height = 1,
		weight = 0.012,
		--category = "Attachments",
	...
	["ammo_9x18_old"] = {
		name = "9x18 OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 569, --15ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_9x18_fmj_old.mdl",
		width = 1,
		height = 1,
		weight = 0.01,
		--category = "Attachments",
	...
	["ammo_9x39_old"] = {
		name = "9x39mm OLD Ammo Box",
		desc = "A box of ammo currently containing %s rounds.", --use %s for number
		price = 1624,--96ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_9x39_pab9_old.mdl",
		width = 2,
		height = 1,
		weight = 0.025,
		--category = "Attachments",
	...
	["ammo_45acp_old"] = {
		name = "45 ACP OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 1056,--35ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_1143x23_fmj_old.mdl",
		width = 2,
		height = 1,
		weight = 0.02,
		--category = "Attachments",
	...
	["ammo_50ae_old"] = {
		name = "50 AE OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 1219,--40ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_50_ae_old.mdl",
		width = 2,
		height = 1,
		weight = 0.02,
		--category = "Attachments",
	...
	["ammo_762x25_old"] = {
		name = "7.62x25mm OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 760,--27ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_762x25_p_old.mdl",
		width = 1,
		height = 1,
		weight = 0.01,
		--category = "Attachments",
	...
	["ammo_762x39_old"] = {
		name = "7.62x39mm OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 995,--52ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_762x39_fmj_old.mdl",
		width = 2,
		height = 1,
		weight = 0.016,
		--category = "Attachments",
	...
	["ammo_762x51_old"] = {
		name = "7.62x51mm NATO OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 1462,--80ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_762x51_fmj_old.mdl",
		width = 2,
		height = 1,
		weight = 0.025,
		--category = "Attachments",
	...
	["ammo_762x54_old"] = {
		name = "7.62x54mmR OLD Ammo Box",
		desc = "A box of ammo old currently containing %s rounds.", --use %s for number
		price = 910,--75ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_762x54_7h1_old.mdl",
		width = 2,
		height = 1,
		weight = 0.022,
		--category = "Attachments",
	...
	["ammo_556_old"] = {
		name = "5.56x45mm OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 1462,--55ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_556x45_ss190_old.mdl",
		width = 2,
		height = 1,
		weight = 0.011,
		--category = "Attachments",
	...
	["ammo_545_old"] = {
		name = "5.45x39mm OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 887,--50ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_545x39_fmj_old.mdl",
		width = 2,
		height = 1,
		weight = 0.01,
		--category = "Attachments",
	...
	["ammo_338_old"] = {
		name = "338 Lapua OLD Ammo Box",
		desc = "A box of old ammo currently containing %s rounds.", --use %s for number
		price = 2763,--200ea
		model = "models/wick/wrbstalker/anomaly/items/wick_ammo_762x54_ap_old.mdl",
		width = 2,
		height = 1,
		weight = 0.044,
		--category = "Attachments",
