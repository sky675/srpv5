ITEM.name = "One Hole Balaclava"
ITEM.desc = "A balaclava with an eye hole. May have clipping issues with some headgear."
ITEM.model = "models/sky/dropped/mask_balaclava1.mdl"
