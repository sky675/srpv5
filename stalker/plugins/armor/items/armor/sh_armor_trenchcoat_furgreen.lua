ITEM.name = "Trenchcoat (Green w/ Fur)"
ITEM.desc = "A common trenchcoat. Additionally has a fur hood."
...
ITEM.price = 26320 --+3000 for luxury shit
ITEM.flag = "1"
...
local matreplace = {	
	["trenchcoat_black"] = "models/sky/stalker/trenchcoat_fur_green"
}
