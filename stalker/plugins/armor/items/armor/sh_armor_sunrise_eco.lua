ITEM.name = "Ecologist Guard Suit (Blue)"
...
local matreplace = {	
	["beri_lone"] = "models/sky/stalker/beri_eco",
	...
	["sunrise_lone"] = "models/sky/stalker/psz9d_eco2",
	["sunrise_null"] = "models/sky/stalker/psz9d_eco2"
}
