...
ITEM:postHook("Equip", function(item, result, data)
	...
	if(mat) then
		item.player:SetSubMaterial(mat, "models/sky/stalker/seva_duty")
		local sub = item.player:getChar():getData("submat", {})
		sub["seva_lone"] = "models/sky/stalker/seva_duty"
