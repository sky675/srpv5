ITEM.name = "IO7A Suit (Black)"
ITEM.desc = "A suit officially designated as 'Light Combat Suit', commonly worn by Mercenaries. This has been dyed black."
