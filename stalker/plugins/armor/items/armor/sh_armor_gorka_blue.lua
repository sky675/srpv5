ITEM.name = "Gorka Suit (Blue)" --cs1/light novice
...
local matreplace = {					--blue is soldier_fbs_23fb_01_01_b_diff
	["spetsnaz_body_black"] = "models/sky/gorka/soldier_fbs_23fb_01_01_b_diff",
	["spetsnaz_legs_black"] = "models/sky/gorka/soldier_fbs_23fb_01_02_b_diff",
}
