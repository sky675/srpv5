...
ITEM.skin = 4 --todo change based on ingame data
ITEM.weight = 13.4
ITEM.addWeight = 18
ITEM.width = 2
ITEM.height = 3
ITEM.outfitCategory = "armor;head;mask;eyes"
ITEM.price = 72400--70400
ITEM.flag = "m"
...
ITEM:postHook("Equip", function(item, result, data)
	...
	if(mat) then
		item.player:SetSubMaterial(mat, "models/sky/stalker/seva_midn")
		local sub = item.player:getChar():getData("submat", {})
		sub["seva_lone"] = "models/sky/stalker/seva_midn"
