...
ITEM.desc = "A suit based on another suit designated as 'Light Combat Suit', commonly worn by Mercenaries. This appears to be significantly worse than the real suits, however."
...
ITEM.price = 58340--38340--36340 is a bit ridiculous for how bad this suit is--32280
ITEM.flag = "1"
ITEM.size = "light" --helm, light, medium, heavy, exo, mask, vest, sci
...
local matreplace = {	
	...
	["cs1_lone"] = "models/sky/stalker/cs1_blak",
	["cs2_lone"] = "models/sky/stalker/cs2_blak",
	["exo_lone"] = "models/sky/stalker/exo_band",
	["io7a_lone"] = "models/sky/stalker/io7a_band",
