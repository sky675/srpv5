local itemList = {
	...
	["part_boar"] = {
		...
		desc = "",
		price = 670,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_boar_leg.mdl",
		width = 1,
		height = 1,
		weight = 0.234,
		flag = "m",
	...
	["part_chimera"] = {
		...
		desc = "",
		price = 3740,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_chimera_claw.mdl",
		width = 1,
		height = 1,
		weight = 0.122,
		flag = "m",
	...
	["part_dog"] = {
		...
		desc = "",
		price = 620,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_dog_tail.mdl",
		width = 1,
		height = 1,
		weight = 0.082,
		flag = "m",
	...
	["part_flesh"] = {
		...
		desc = "",
		price = 640,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_flesh_eye.mdl",
		width = 1,
		height = 1,
		weight = 0.023,
		flag = "m",
	...
	["part_bloodsucker"] = {
		...
		desc = "",
		price = 1380,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_krovosos_jaw.mdl",
		width = 1,
		height = 1,
		weight = 0.162,
		flag = "m",
	...
	["part_snork_leg"] = {
		...
		desc = "",
		price = 790,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_snork_leg.mdl",
		width = 1,
		height = 1,
		weight = 0.223,
		flag = "m",
	...
	["part_rat"] = {
		...
		desc = "",
		price = 510,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_tushkano_head.mdl",
		width = 1,
		height = 1,
		weight = 0.06,
		flag = "m",
	...
	["part_zombie"] = {
		...
		desc = "",
		price = 620,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_zombie_hand.mdl",
		width = 1,
		height = 1,
		weight = 0.092,
		flag = "m",
	...
	["part_pseudotail"] = {
		...
		desc = "",
		price = 690,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_psevdodog_tail.mdl",
		width = 1,
		height = 1,
		weight = 0.11,
		flag = "m",
	...
	["part_controller_brain"] = {
		...
		desc = "",
		price = 4790,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_controller_brain.mdl",--models/kek1ch/item_controller_brain.mdl",
		width = 1,
		height = 1,
		weight = 1.5,
		flag = "m",
	...
	["part_pseudogiant_hand"] = {
		...
		desc = "",
		price = 5340,--12,
		model = "models/wick/wrbstalker/anomaly/items/wick_item_psevdogigant_hand.mdl",
		width = 1,
		height = 1,
		weight = 0.184,
		flag = "m",
