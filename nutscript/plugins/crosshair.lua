...
nut.xhair.entIcon = {} --dont fuck up the edits i make to it ughhhhhhh
nut.xhair.entIgnore = nut.xhair.entIgnore or {
	func_physbox = true,
	prop_dynamic = true,
	func_breakable = true,
...
function PLUGIN:GetCrosshairIcon(curAlpha, entity, weapon, distance)
	...
	--hide secret buttons :) only way to do this becuz theyre different ents clientside
