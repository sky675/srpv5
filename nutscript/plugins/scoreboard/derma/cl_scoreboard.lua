	...
	function PANEL:Init()
		...
		for k, v in ipairs(nut.faction.indices) do
			...
			list.Think = function(this)
				for k2, v2 in ipairs(team.GetPlayers(v.hideunder or k)) do
	...
	function PANEL:Think()
		if ((self.nextUpdate or 0) < CurTime()) then
			...
			for k, v in ipairs(self.teams) do
				...
				if(!team.hidden or (LocalPlayer():getChar():getFaction() == k) or LocalPlayer():IsAdmin() or (team.ally and team.ally[LocalPlayer():getChar():getFaction()])) then
				else
					v:SetVisible(false)
