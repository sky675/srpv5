...
ITEM.weight = 1
ITEM.weightMulti = 0.5 --weight is multiplied by this
function ITEM:getWeight()
	return self.weight + (self:getInv():getWeight() * self.weightMulti)
end

ITEM.invHoldWeight = 4
ITEM.invWidth = 2
ITEM.invHeight = 2
...
function ITEM:onInstanced()
	...
	nut.inventory.instance(INVENTORY_TYPE_ID, data)
		:next(function(inventory)
			...
			inventory:setData("maxWeight", self.invHoldWeight)
