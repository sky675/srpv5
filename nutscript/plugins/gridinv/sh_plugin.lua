...
PLUGIN.author = "Cheesenut/sky"
PLUGIN.desc = "Inventory system where items have a size and fit in a grid. modified with weight becuz im too lazy to make a plugin based off of this"
