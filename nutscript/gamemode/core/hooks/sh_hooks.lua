...
HOLDTYPE_TRANSLATOR["pistol_2handd"] = "pistol"
...
PLAYER_HOLDTYPE_TRANSLATOR["pistol_2handd"] = "normal"
...
function GM:PhysgunPickup(client, entity)
	if(entity:GetClass():lower() == "func_door" or entity:GetClass():lower() == "func_door_rotating" or entity:GetClass():lower() == "prop_door_rotating" or entity:GetClass():lower() == "func_lod") then return false end
...
TOOL_SAFE["stacker_improved"] = true
TOOL_SAFE["precision"] = true
