...
function renderNewIcon(panel, itemTable)
	local model = itemTable.getModel and itemTable:getModel() or itemTable.model
	-- re-render icons
	if ((itemTable.iconCam and !renderedIcons[string.lower(model)]) or itemTable.forceRender) then
...
function PANEL:updateTooltip()
	self:SetTooltip(
		"<font=nutItemDescFont>Item ID "..self.itemTable:getID().."</font>\n"..
